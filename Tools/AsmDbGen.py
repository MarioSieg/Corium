...
output = "constexpr std::array<const std::initializer_list<const InstructionVariation>, static_cast<U64>(Instruction::Count_)> VARIATION_TABLE\n{\n"
for instr in instrset:
    output += "\tstd::initializer_list<const InstructionVariation>\n"
    output += "\t{\n"
