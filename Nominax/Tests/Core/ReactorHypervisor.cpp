...
{
	CPU::ISAExtensionDetector detector { };
	detector.ClearAllExtensionFlags();
	ASSERT_EQ(HyperVisor::SmartSelectReactor(detector), ReactorCoreSpecialization::Fallback);
}
...
TEST(ReactorHypervisor, GetReactorRoutineFromRegistryByTargetFallback)
{
	...
	(
		...
		(
			HyperVisor::SmartSelectReactor(detector)
...
TEST(ReactorHypervisor, GetOptimalReactorRoutine)
{
	CPU::ISAExtensionDetector detector { };
	detector.ClearAllExtensionFlags();
	const ReactorRoutineLink data { HyperVisor::GetOptimalReactorRoutine(detector) };
...
{
	CPU::ISAExtensionDetector features { };
	const_cast<CPU::ISAExtensionMask&>(*features)[static_cast<std::uint64_t>(CPU::ISAExtensionBit::AVX)]     = true;
	const_cast<CPU::ISAExtensionMask&>(*features)[static_cast<std::uint64_t>(CPU::ISAExtensionBit::AVX512F)] = false;
...
{
	CPU::ISAExtensionDetector features { };
	const_cast<CPU::ISAExtensionMask&>(*features)[static_cast<std::uint64_t>(CPU::ISAExtensionBit::AVX512F)] = true;
...
{
	const CPU::ISAExtensionDetector featuress { };
	if (featuress[CPU::ISAExtensionBit::AVX512F])
	{
		ASSERT_EQ(HyperVisor::SmartSelectReactor(featuress), ReactorCoreSpecialization::X86_64_AVX512F);
	}
	else if (featuress[CPU::ISAExtensionBit::AVX])
	{
		ASSERT_EQ(HyperVisor::SmartSelectReactor(featuress), ReactorCoreSpecialization::X86_64_AVX);
	}
	else
	{
		ASSERT_EQ(HyperVisor::SmartSelectReactor(featuress), ReactorCoreSpecialization::Fallback);
	}
}
...
TEST(ReactorHypervisor, GetReactorRoutineFromRegistryByTargetAvx)
{
	...
	(
		HyperVisor::GetReactorRoutineFromRegistryByTarget
		(
			HyperVisor::SmartSelectReactor(features)
