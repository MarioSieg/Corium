...
{
	[[nodiscard]]
	NOX_HOT extern auto VM_ExecutionPort_Fallback
	(
	...
	[[nodiscard]]
	NOX_HOT extern auto VM_ExecutionPort_Debug
	(
		const InputDescriptor* input,
		OutputState* output,
		const void*** outJumpTable
	...
	[[nodiscard]]
	NOX_HOT extern auto VM_ExecutionPort_Instrument
	(
		const InputDescriptor* input,
		OutputState* output,
		const void*** outJumpTable
		...
		[[nodiscard]]
		NOX_HOT extern auto VM_ExecutionPort_AVX
		(
			const InputDescriptor* input,
			OutputState* output,
			const void*** outJumpTable
		...
		[[nodiscard]]
		NOX_HOT extern auto VM_ExecutionPort_AVX512F
		(
			const InputDescriptor* input,
			OutputState* output,
			const void*** outJumpTable
