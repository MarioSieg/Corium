...
{
    /// <summary>
    /// Represents the inner layout of a 64-bit GPR register such as %x0 or %x3.
    /// </summary>
    union alignas(alignof(std::uint64_t)) GPRRegister64Layout
    {
        ...
        /// <summary>
        /// Represents the inner layout of a 32-bit GPR register such as %w0 or %w3.
        /// </summary>
        ...
        public:
            ...
            static_assert(sizeof(Inner) == sizeof(std::uint32_t));
        } Lo32;
    ...
    /// <summary>
    /// Represents the inner layout of a 128-bit Neon SIMD register such as %v0 oder %v15.
    /// </summary>
    union alignas(alignof(std::uint64_t)) NeonRegister128Layout
    {
        struct alignas(alignof(std::uint64_t))
        {
            union alignas(alignof(std::uint64_t)) NeonWord64
            {
                std::uint64_t AsU64;
                std::int64_t AsI64;
            ...
            static_assert(sizeof(NeonWord64) == sizeof(std::uint64_t));
        } Inner;
    ...
    static_assert(sizeof(NeonRegister128Layout) == sizeof(std::uint64_t) << 1);
    static_assert(std::is_trivial_v<NeonRegister128Layout>);
}