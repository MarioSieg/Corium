...
namespace Nominax::Assembler::X86_64
{
    ...
    union alignas(alignof(std::uint64_t)) GPRRegister64Layout
    {
        ...
        /// <summary>
        /// Represents the inner layout of a 32-bit GPR register such as %eax or %ebx.
        /// </summary>
        ...
        public:
           union alignas(alignof(std::uint32_t))
           {
               ...
               /// <summary>
               /// Represents the inner layout of a 16-bit GPR register such as %ax or %bx.
               /// </summary>
               ...
               public:
                   union alignas(alignof(std::uint16_t))
                   {
                       ...
                       {
                           /// <summary>
                           /// Represents the inner layout of a 8-bit GPR register such as %al or %ah.
                           /// </summary>
