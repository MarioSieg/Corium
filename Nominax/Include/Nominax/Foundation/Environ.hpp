...
#if NOX_OS_WINDOWS
#define NOX_ENVIRON _environ
#else
#define NOX_ENVIRON environ
#endif
...
{
	/// <summary>
	/// Query environment variable table.
	/// </summary>
	/// <returns></returns>
	inline auto GetEnviron() noexcept -> const char* const*
	{
		return NOX_ENVIRON;
	}

	/// <summary>
	/// Counts the amount of entries in the environ array.
	/// </summary>
