...
namespace Nominax::Foundation::Memory
{
	...
	/// </summary>
	NOX_INTRINSIC_PROXY inline auto ReadBarrier() noexcept -> void
	{
		asm volatile("" : : : "memory");
	}
	...
	/// Force the compiler to flush queued writes to global memory.
	/// </summary>
	NOX_INTRINSIC_PROXY inline auto WriteBarrier() noexcept -> void
	{
		asm volatile("" : : : "memory");
	}
	...
	/// Force the compiler to flush queued writes to global memory.
	/// </summary>
	NOX_INTRINSIC_PROXY inline auto ReadWriteBarrier() noexcept -> void
	{
		asm volatile("" : : : "memory");
	}
