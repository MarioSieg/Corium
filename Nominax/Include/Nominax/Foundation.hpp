...
#error "Unimplemented architecture!"
    ...
    struct ObjectHeader final
    {
        ...
        [[nodiscard]]
        static constexpr auto ReadMapping_MetaField(const Foundation::Record* region) -> U32;
        ...
        /// <returns></returns>
        static constexpr auto WriteMapping_MetaField(Foundation::Record* region, U32 MetaField) -> void;
        ...
        /// <param name="region"></param>
        /// <returns></returns>
        static constexpr auto WriteMapping_IncrementMetaField(Foundation::Record* region) -> void;
        ...
        /// <param name="region"></param>
        /// <returns></returns>
        static constexpr auto WriteMapping_DecrementMetaField(Foundation::Record* region) -> void;
    ...
    NOX_FLATTEN constexpr auto ObjectHeader::ReadMapping_MetaField(const Foundation::Record* const region) -> U32
    {
    ...
    NOX_FLATTEN constexpr auto ObjectHeader::WriteMapping_MetaField(Foundation::Record* const region, const U32 MetaField) -> void
    {
        (*region).AsU32S[0] = MetaField;
    }

    NOX_FLATTEN constexpr auto ObjectHeader::WriteMapping_IncrementMetaField(Foundation::Record* const region) -> void
    {
        ++(*region).AsU32S[0];
    }

    NOX_FLATTEN constexpr auto ObjectHeader::WriteMapping_DecrementMetaField(Foundation::Record* const region) -> void
    {
        --(*region).AsU32S[0];
    }
