...
{
	/// <summary>
	/// Additional meta data flags for a subroutine.
	...
	constexpr std::array<const std::string_view, Foundation::Algorithm::ToUnderlying(SubroutineAttributes::Count_)> SUBROUTINE_ATTRIBUTE_NAMES
	{
		"NONE",
		"FORCE_INLINE",
		"NO_INLINE",
	...
	constexpr std::string_view SUBROUTINE_ATTRIBUTE_PREFIX { "__" };
}
