...
namespace Nominax::ByteCode
{
	...
	constexpr std::array<const std::string_view, static_cast<std::size_t>(Instruction::Count)> INSTRUCTION_DESCRIPTIONS
	{
		...
		"integer negation",
		"F32ing point addition",
		"F32ing point subtraction",
		"F32ing point multiplication",
		"F32ing point division",
		"F32ing point remainder",
		"F32ing point negation",
		"F32ing point increment",
		"F32ing point decrement",
		"push quad vector",
		"pop quad vector",
		"F32ing point quad vector addition",
		"F32ing point quad vector subtraction",
		"F32ing point quad vector multiplication",
		"F32ing point quad vector division",
	};
}
