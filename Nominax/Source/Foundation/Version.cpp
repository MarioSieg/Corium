...
#include "../../Include/Nominax/Foundation/Protocol/_Protocol.hpp"

namespace Nominax::Foundation
{
    static constexpr std::string_view SYSTEM_COPYRIGHT_TEXT =
    ...
    static constexpr std::string_view SYSTEM_LOGO_TEXT = R"(
                                                         #@@#
                                                      %@@@@@@@@@
                                                     .@@@    (@@
                                                            &@@@
  ...
  ,@@@@@@@(           @@@@@@@@@@@          .@@@@@@@@@
    ...
    static constexpr std::string_view LICENSE = R"(
	                                  Apache License
    ...
    auto Version::Display(std::ostream& stream) const -> void
    {
