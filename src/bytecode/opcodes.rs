...
pub enum OpCode {
    ...
    Jump = ops::JUMP,
    JumpEquals = ops::JUMP_EQUALS,
    JumpNotEquals = ops::JUMP_NOT_EQUALS,
    JumpAbove = ops::JUMP_ABOVE,
    JumpAboveEquals = ops::JUMP_ABOVE_EQUALS,
    JumpLess = ops::JUMP_LESS,
    JumpLessEquals = ops::JUMP_LESS_EQUALS,
    I32Add = ops::I32_ADD,
    I32Sub = ops::I32_SUB,
    I32Mul = ops::I32_MUL,
    I32Div = ops::I32_DIV,
