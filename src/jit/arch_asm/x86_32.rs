...
use crate::jit::arch_asm::isa::*;

pub enum Registers {
    Eax, // General purpose register (GPR).
    Ebx, // General purpose register (GPR).
    Ecx, // General purpose register (GPR).
    Edx, // General purpose register (GPR).

    Esi, // Destination source pointer.
...
pub const REGISTERS: &[Register<'static>] = &[
    // EAX:
    Register {
        target_type: RegisterTargetType::Word,
        bit_size: 32,
        mnemonic: "eax",
        is_extension: false,
