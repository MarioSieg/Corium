...
pub const MNEMONIC_TABLE: [&str; Instruction::Count_ as usize] = [
    ...
    "dupl2", "swap", "nop", "jmp", "jmpr", "jz", "jnz", "jocmpi", "jocmpf", "jnocmpi", "jnocmpf",
    "jecmpi", "jecmpf", "jnecmpi", "jnecmpf", "jacmpi", "jacmpf", "jlcmpi", "jlcmpf", "jaecmpi",
    "jaecmpf", "jlecmpi", "jlecmpf", "pushz", "ipusho", "fpusho", "iinc", "idec", "iadd", "isub",
    "imul", "idiv", "imod", "iand", "ior", "ixor", "icom", "isal", "isar", "irol", "iror", "ineg",
    "fadd", "fsub", "fmul", "fdiv", "fmod", "fneg", "finc", "fdec", "vpush", "vpop", "vadd",
    "vsub", "vmul", "vdiv", "mpush", "mpop", "madd", "msub", "mmul", "mdiv", "cvti2f", "cvtf2i",
    "cvti2c", "cvti2b", "gcalloc", "derefw", "derefr",
];
...
pub const PUSH_RECORD_TABLE: [u8; Instruction::Count_ as usize] = [
    ...
    /* vsub     */ 4, /* vmul     */ 4, /* vdiv     */ 4, /* mpush    */ 16,
    /* mpop     */ 0, /* madd     */ 16, /* msub     */ 16, /* mmul     */ 16,
    /* mdiv     */ 16, /* cvti2f   */ 1, /* cvtf2i   */ 1, /* cvti2c   */ 1,
    /* cvti2b   */ 1, /* gcalloc  */ 1, /* derefw   */ 0, /* derefr   */ 1,
];
...
pub const POP_RECORD_TABLE: [u8; Instruction::Count_ as usize] = [
    ...
    /* mpop     */ 16, /* madd     */ 32, /* msub     */ 32, /* mmul     */ 32,
    /* mdiv     */ 32, /* cvti2f   */ 1, /* cvtf2i   */ 1, /* cvti2c   */ 1,
    /* cvti2b   */ 1, /* gcalloc  */ 0, /* derefw   */ 1, /* derefr   */ 0,
];
...
pub const IMMEDIATE_TABLE: [u8; Instruction::Count_ as usize] = [
    ...
    /* vsub     */ 0, /* vmul     */ 0, /* vdiv     */ 0, /* mpush    */ 16,
    /* mpop     */ 0, /* madd     */ 0, /* msub     */ 0, /* mmul     */ 0,
    /* mdiv     */ 0, /* cvti2f   */ 0, /* cvtf2i   */ 0, /* cvti2c   */ 0,
    /* cvti2b   */ 0, /* gcalloc  */ 1, /* derefw   */ 1, /* derefr   */ 1,
];
