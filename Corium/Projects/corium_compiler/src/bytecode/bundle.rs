...
impl fmt::Display for BundleConfig {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        ...
        let mut file_name = self.file_name.chars().fold(String::new(), |mut s, n| {
            write!(s, "{:X},", (n as u64) << 1).ok();
            s
        });
        ...
        writeln!(
            f,
            "{}",
            format_bytecode_macro!(FILENAME_LEN, self.file_name.len())
        )?;
        writeln!(f, "{}", format_bytecode_macro!(FILENAME_DEF, file_name))?;
        writeln!(
            f,
            "{}",
...
impl Bundle {
    ...
    pub const HEADER: &'static [&'static str] = &[
        "This file was generated by the Corium compiler for the Nominax runtime system!",
        "This file contains Nominax bytecode in a special syntax and format, readable by the Nominax runtime system!",
        "Do NOT modify!"
    ];
