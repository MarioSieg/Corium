...
pub const UNDEFINE: &str = "undef";
pub const IF_DEFINED: &str = "ifdef";
pub const IF_NOT_DEFINED: &str = "ifndef";
pub const ELISE_IF_DEFINED: &str = "elifdef";
pub const ELISE_IF_NOT_DEFINED: &str = "elifndef";
...
pub mod subroutine {
    ...
    pub const FORCE_INLINE: &str = "FORCE_INLINE";
    pub const NO_INLINE: &str = "NO_INLINE";
    pub const PURE: &str = "PURE";
    pub const RECURSIVE: &str = "RECURSIVE";
    pub const HOT: &str = "HOT";
    pub const COLD: &str = "COLD";
    pub const FORCE_JIT: &str = "FORCE_JIT";
    pub const NO_JIT: &str = "NO_JIT";
    pub const NO_RET: &str = "NO_RET";
