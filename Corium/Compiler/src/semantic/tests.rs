...
mod invalid {
    ...
    mod global {
        ...
        #[test]
        fn two_mutable_variables_with_same_identifier() {
            let var = mocks::global::mut_var1();
            let mut context = Context::new("Test.cor");
            context.analyze_global(&var);
            context.analyze_global(&var);
            assert!(context.has_errors());
        }

        #[test]
        fn two_immutable_variables_with_same_identifier() {
            let var = mocks::global::const_var1();
            let mut context = Context::new("Test.cor");
            context.analyze_global(&var);
            context.analyze_global(&var);
            assert!(context.has_errors());
        ...
        #[test]
        fn mutable_and_immutable_variable_with_same_identifier() {
            let x = mocks::global::mut_var1();
            let y = mocks::global::const_var1();
            let mut context = Context::new("Test.cor");
            context.analyze_global(&x);
            context.analyze_global(&y);
            assert!(context.has_errors());
        }

        #[test]
        fn immutable_and_mutable_variable_with_same_identifier() {
            let x = mocks::global::const_var1();
            let y = mocks::global::mut_var1();
            let mut context = Context::new("Test.cor");
            context.analyze_global(&x);
            context.analyze_global(&y);
            assert!(context.has_errors());
        ...
        #[test]
        fn two_functions_with_same_identifier() {
            let fun = mocks::global::fun1();
            let mut context = Context::new("Test.cor");
            context.analyze_global(&fun);
            context.analyze_global(&fun);
            assert!(context.has_errors());
        }

        #[test]
        fn function_and_mutable_variable_with_same_identifier() {
            let fun = mocks::global::fun1();
            let var = mocks::global::mut_var3();
            let mut context = Context::new("Test.cor");
            context.analyze_global(&fun);
            context.analyze_global(&var);
            assert!(context.has_errors());
        ...
        #[test]
        fn function_and_immutable_variable_with_same_identifier() {
            let fun = mocks::global::fun1();
            let var = mocks::global::const_var3();
            let mut context = Context::new("Test.cor");
            context.analyze_global(&fun);
            context.analyze_global(&var);
            assert!(context.has_errors());
    ...
    mod local {
        ...
        fn local_to_global<'ast>(local: &[&LocalStatement<'ast>]) -> GlobalStatement<'ast> {
            GlobalStatement::Function(Function {
                ...
                block: Block(local.iter().map(|x| (*x).clone()).collect()),
            })
        }

        #[test]
        fn two_mutable_variables_with_same_identifier() {
            let var = mocks::local::mut_var1();
            let locals = local_to_global(&[&var, &var]);
            let mut context = Context::new("Test.cor");
            context.analyze_global(&locals);
            assert!(context.has_errors());
        }

        #[test]
        fn two_immutable_variables_with_same_identifier() {
            let var = mocks::local::const_var1();
            let locals = local_to_global(&[&var, &var]);
            let mut context = Context::new("Test.cor");
            context.analyze_global(&locals);
            assert!(context.has_errors());
        ...
        #[test]
        fn mutable_and_immutable_variable_with_same_identifier() {
            let x = mocks::local::mut_var1();
            let y = mocks::local::const_var1();
            let locals = local_to_global(&[&x, &y]);
            let mut context = Context::new("Test.cor");
            context.analyze_global(&locals);
            assert!(context.has_errors());
        }
        ...
        #[test]
        fn immutable_and_mutable_variable_with_same_identifier() {
            let x = mocks::local::const_var1();
            let y = mocks::local::mut_var1();
            let locals = local_to_global(&[&x, &y]);
            let mut context = Context::new("Test.cor");
            context.analyze_global(&locals);
            assert!(context.has_errors());
        ...
        #[test]
        fn function_and_local_mutable_variable_with_same_identifier() {
            let fun = mocks::global::fun1();
            let var = mocks::local::mut_var3();
            let locals = local_to_global(&[&var]);
            let mut context = Context::new("Test.cor");
            context.analyze_global(&fun);
            context.analyze_global(&locals);
            assert!(context.has_errors());
        ...
        #[test]
        fn function_and_local_immutable_variable_with_same_identifier() {
            let fun = mocks::global::fun1();
            let var = mocks::local::const_var3();
            let locals = local_to_global(&[&var]);
            let mut context = Context::new("Test.cor");
            context.analyze_global(&fun);
            context.analyze_global(&locals);
